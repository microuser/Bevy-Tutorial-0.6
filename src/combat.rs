...
use crate::{
    ...
    player::Player,
    GameState, ASPECT_RATIO, TILE_SIZE,
};
...
fn spawn_combat_menu(
    ...
    let run_center_x = ASPECT_RATIO - (run_width * TILE_SIZE) / 2.0;
    ...
    let fight_center_x = ASPECT_RATIO - (run_width * TILE_SIZE) - (fight_width * TILE_SIZE / 2.0);
